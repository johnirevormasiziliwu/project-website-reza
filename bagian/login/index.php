...
<html lang="en">
  <head>
    ...
    <title>Arsip Surat Komisi Pemilihan Umum</title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="proses_login.php" id="login" name="login" method="post">
              ...
              <div class="separator">
                <div>
                  <h2><i class="fa fa-institution"></i> KOMISI PEMILIHAN UMUM PROVINSI KALIMANTAN SELATAN</h2>
                  <p>©2023 Komisi Pemilihan Umum Republik Indonesia</p>
                </div>
              </div>
            </form>
          </section>
